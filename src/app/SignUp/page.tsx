        ...
        <div className="flex px-5">
            ...
            <div className="py-20 px-10 h-full w-[45vw] flex flex-col gap-4"> 
                ...
                <div className="flex flex-col h-[60vh] justify-between">
                    ...
                    <button onClick={()=>{SignUpHandler()}} className="border text-white bg-[#A259FF] border-3 border-black rounded-full w-[30vw] h-[9vh] rounded-full font-bold">Create Account</button>
                </div>
