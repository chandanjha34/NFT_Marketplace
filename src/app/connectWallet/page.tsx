...
import { metamaskConnect, connectCoinbase, connectWalletConnect } from "@/Wallet/walletConnect";
...
const connectWallet = ()=>{
    ...
    const connect = async (type:string) => {
        ...
        if(type=='walletConnect') value = await connectWalletConnect();
        if(type=='coinbase') value = await connectCoinbase();
        console.log(value);
