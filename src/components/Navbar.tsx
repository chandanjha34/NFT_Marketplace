    ...
    return(
        <div className='flex p-3 gap-130 justify-center text-white'>
            ...
            <div className='flex flex-row w-[40vw] justify-between items-center'>
                ...
                <div><button onClick={routeToSignup} className={` hover:bg-[#2B2B2B] w-[10vw] bg-[#A259FF] px-8 cursor-pointer w-full h-10 border border-2 border-[#A259FF] rounded-full`}>{username?`${username.slice(9)}`:'Sign Up'}</button></div>
            </div>
        </div>
    );
}